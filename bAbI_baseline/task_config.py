...
default_args = {
    ...
    "separate": True,
    "answer_fact": {
        "predicate_name": "answer",
        "relevant_terms_inds": [0],
        "specified_terms": {},
    },
    "custom_parse": False,
...
task4_dict = {
    "iterative": True,
    "context_preprocess": preprocess4,
    "stops": 2 * [None],
    "parse_word": 2 * ["\nSemantic parse:"],
    "modules": ["location"],
    "temporal_stamp": False,
}
task5_dict = {
    "iterative": True,
    "stops": 2 * [None],
...
task16_dict = {
    ...
    "parse_word": 2 * ["\nSemantic parse:"],
    "temporal_stamp": False,
    "post_processing": post_process16,
    "separate": True,
}  #'answer_fact': {'predicate_name':'isColor','relevant_terms_inds':[1], 'specified_terms' :{0:'action',1:'agent'}}}
task17_dict = {
    "iterative": False,
    "stops": ["Sentences", "Objects"],
    "parse_word": ["\nObjects:", "\nQuery Fact: "],
    "modules": ["location"],
    "temporal_stamp": False,
    "separate": True,
    "custom_parse": custom17,
}
task18_dict = {
    "iterative": True,
    "stops": 2 * [None],
...
task19_dict = {
    ...
    "stops": 2 * [None],
    "parse_word": 2 * ["\nSemantic parse:"],
    "modules": ["DEC_AXIOMS", "action", "location"],
    "temporal_stamp": False,
    "separate": True,
    "post_processing": order_plan,
    "answer_fact": {
        "predicate_name": "happens",
        "relevant_terms_inds": [3, 4],
        "specified_terms": {0: "action", 1: "agent"},
    },
}
task20_dict = {
    "iterative": True,
